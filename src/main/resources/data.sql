...
INSERT INTO users (username, password, enabled) values ('user', '{bcrypt}$2a$10$6Ro9EyzfGccxSfkqGjOkwOOticF1jApUiXNwtU/0eJAb.cTWKSKCm', true);
INSERT INTO users (username, password, enabled) values ('admin', '{bcrypt}$2a$10$6Ro9EyzfGccxSfkqGjOkwOOticF1jApUiXNwtU/0eJAb.cTWKSKCm', true);
